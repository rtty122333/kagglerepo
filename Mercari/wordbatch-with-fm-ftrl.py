...
def main():
    ...
    model = FTRL(alpha=0.01, beta=0.1, L1=0.00001, L2=1.0, D=sparse_merge.shape[1], iters=51, inv_link="identity", threads=1)
    ...
    preds = (predsF * 0.12 + predsL * 0.22 + predsFM * 0.66)
